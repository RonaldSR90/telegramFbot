...
public class MyFirstTelegramBot extends MultiSessionTelegramBot {
    ...
    public static final String NAME = "RonSR_bot";
    public static final String TOKEN = "6741467120:AAGtXc5hyo1YrCsrtofw-LOskxo01BhB2n8";
    ...
    public void onUpdateEventReceived(Update update) {
        ...
        if (getCallbackQueryButtonKey().equals("step_5_btn")){
            ...
            sendTextMessageAsync(STEP_6_TEXT,
                    Map.of("Tomar una selfie! +40 de fama", "step_6_btn"));
        }
        ...
        if (getCallbackQueryButtonKey().equals("step_6_btn")){
            ...
            sendTextMessageAsync(STEP_7_TEXT,
                    Map.of("Hackear computadora", "step_7_btn"));
        }
        ...
        if (getCallbackQueryButtonKey().equals("step_7_btn")){
            ...
            sendTextMessageAsync(STEP_8_TEXT,
                    Map.of("Crear blog para guiar otros gatos", "step_8_btn"));
        }
